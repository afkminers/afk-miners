...
Arquivo: `server\routes\afk.js:26`
...
- `HTTP 500` → {error:String(e) }
- `HTTP 401` → {error:'auth required' }
- `HTTP 500` → {error:String(e) }
- `HTTP 401` → {error:'auth required' }
- `HTTP 400` → {error:'workerId required' }
- `HTTP 500` → {error:String(e) }
- `HTTP 401` → {error:'auth required' }
- `HTTP 500` → {error:String(e) }
...
Arquivo: `server\routes\afk.js:57`
...
Arquivo: `server\routes\afk.js:71`
