...
Arquivo: `server\auth\routes.js:82`

_Sem payload inferido_

**Resposta de sucesso (amostra):**
```json
{id:user.id,name:user.name,coins:user.coins,gems:user.gems,createdAt:user.createdAt }
```
...
Arquivo: `server\auth\routes.js:116`
