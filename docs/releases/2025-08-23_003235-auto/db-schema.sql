...
CREATE TABLE player_heroes (id TEXT PRIMARY KEY, playerId TEXT NOT NULL, heroKey TEXT NOT NULL, name TEXT NOT NULL, rarity TEXT NOT NULL, attack INTEGER DEFAULT 0, defense INTEGER DEFAULT 0, speed INTEGER DEFAULT 0, createdAt INTEGER NOT NULL, level INTEGER DEFAULT 1);
