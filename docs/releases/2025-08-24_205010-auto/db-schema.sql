CREATE TABLE players (id TEXT PRIMARY KEY, name TEXT UNIQUE NOT NULL, password_hash TEXT, coins INTEGER NOT NULL DEFAULT 0, gems INTEGER NOT NULL DEFAULT 0, createdAt INTEGER NOT NULL, role TEXT DEFAULT 'player');
