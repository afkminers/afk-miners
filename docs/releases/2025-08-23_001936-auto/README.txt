...
--------------------------------
Pasta: docs/releases/2025-08-23_001936-auto
...
Arquivos principais neste pacote:
 - API.md                  → documentação legível (payloads, erros, env, histórico, TODO)
 ...
 - route-history.json      → rota → modified/unchanged/no-tag
 - todos.json              → TODO/FIXME por arquivo/linha
